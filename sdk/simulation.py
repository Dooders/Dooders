...
class Simulation(BaseSimulation):
    ...
    def simulation_summary(self):
        return {'SimulationID': self.simulation_id,
                ...
                'TotalEnergy': sum(self.resources.history['allocated_energy']),
                'DissipatedEnergy': sum(self.resources.history['dissipated_energy']),
                'ConsumedEnergy': sum(self.resources.history['consumed_energy']),
                'StartingDooderCount': self.society.dooders_created,
